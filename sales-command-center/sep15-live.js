  ...
  function apply(){
    ...
    s={
      ...
      tasks:[
        ...
        {id:'sep15-5',name:'Due Follow-Up Queue',action:'Work the hottest overdue conversations first',note:'Recover missed appointments and pitched business before spending too much time on colder aged leads.',priority:'high',done:false},
        {id:'sep15-6',name:'Fresh Lead Flow',action:'KEEP NEW LEADS RUNNING',note:'Keep fresh traffic moving between appointment windows so the next close is already entering the funnel.',priority:'high',done:false}
      ]
    };
    ...
    if(heroCopy)heroCopy.textContent='Current board: 3 appointments set today, 2 pitches completed, 1 sale, and $6,296.16 Written AV. Germain closed from the 1:00 PM appointment; Stephanie is at 2:00 PM and Paul at 7:30 PM.';
    ...
    if(head){
      ...
      focus.innerHTML='<div class="eyebrow">TUESDAY GAME PLAN • BUILD ON THE CLOSE</div><div class="leadFlowTitle">Germain closed • Stephanie at 2:00 + Paul at 7:30</div><div class="leadFlowCopy">Germain converted the 1:00 PM appointment into $6,296.16 Written AV. Keep the momentum: protect Stephanie\'s 2:00 PM and Paul\'s 7:30 PM windows, then use the gaps for fresh lead flow and Joy recovery.</div><div class="leadFlowMix"><div><b>15%</b><span>No-Show Recovery</span></div><div><b>25%</b><span>Fresh Lead Flow</span></div><div><b>60%</b><span>Appointments + Close</span></div></div>';
    ...
    const pipelineCounts=[40,23,5,13,10,5,24];
