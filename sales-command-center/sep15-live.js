(() => {
  ...
  function apply(){
    ...
    if(heroCopy)heroCopy.textContent='Christine Milham has now been worked and pitched today with no hard follow-up appointment set. Joy Tennyson missed at 9:30 AM; protect Germain Kennard at 1:00 PM. Current board: 1 appointment set, 1 pitch completed, 0 sales, and $0 Written AV so far.';
    ...
    if(head){
      ...
      focus.innerHTML='<div class="eyebrow">TUESDAY GAME PLAN • RECOVER + CLOSE</div><div class="leadFlowTitle">Recover Joy + protect Germain at 1:00 PM</div><div class="leadFlowCopy">Christine is already worked and pitched for today, with no hard appointment time to protect. Recover Joy from the 9:30 miss, keep fresh lead flow moving, and center the next close window on Germain at 1:00 PM.</div><div class="leadFlowMix"><div><b>25%</b><span>No-Show Recovery</span></div><div><b>35%</b><span>Fresh Lead Flow</span></div><div><b>40%</b><span>1 PM Appointment + Close</span></div></div>';
