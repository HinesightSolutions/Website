(() => {
  ...
  function apply(){
    ...
    if(heroCopy)heroCopy.textContent='Current board: 3 appointments set today, 1 pitch completed, 0 sales, and $0 Written AV so far. Germain is at 1:00 PM, Stephanie at 2:00 PM, and Paul at 7:30 PM; Joy remains a missed-appointment recovery.';
    ...
    if(head){
      ...
      focus.innerHTML='<div class="eyebrow">TUESDAY GAME PLAN • PROTECT THE CLOSE WINDOWS</div><div class="leadFlowTitle">Germain at 1:00 + Stephanie at 2:00 + Paul at 7:30</div><div class="leadFlowCopy">Christine is already worked and pitched today. Recover Joy from the morning miss, then protect the back-to-back 1:00 PM and 2:00 PM windows before Paul\'s 7:30 PM close opportunity.</div><div class="leadFlowMix"><div><b>15%</b><span>No-Show Recovery</span></div><div><b>25%</b><span>Fresh Lead Flow</span></div><div><b>60%</b><span>Appointments + Close</span></div></div>';
      head.parentNode.insertBefore(focus,head);
      const schedule=document.createElement('section');schedule.className='card daySchedule';
      schedule.innerHTML='<div class="eyebrow">CLOSE WINDOWS</div><div class="dayScheduleTitle">Current appointment schedule</div><div class="dayScheduleItems"><span class="dayScheduleItem"><strong>9:30 AM</strong> Joy Tennyson — MISSED</span><span class="dayScheduleItem"><strong>1:00 PM</strong> Germain Kennard — Appointment</span><span class="dayScheduleItem"><strong>2:00 PM</strong> Stephanie Blackmon — Appointment</span><span class="dayScheduleItem"><strong>7:30 PM</strong> Paul Creason — Appointment</span><span class="dayScheduleItem"><strong>Wed 5:30 PM</strong> Aurora Kramer — Appointment</span><span class="dayScheduleItem"><strong>Sat 11:30 AM</strong> Victoria Thompson — Appointment</span></div>';
    ...
    const pipelineCounts=[40,24,5,12,10,5,24];
