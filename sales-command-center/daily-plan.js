(() => {
  ...
  try {
    ...
    if(heroCopy) heroCopy.textContent='Current board: 2 positive responses, 0 pitches, 0 sales, $0 Written AV, and $0 Issued AV. Germain Kennard and Larry Marion are the two warm conversations on the board today — keep converting while protecting the scheduled close windows.';
    ...
    if(head){
      ...
      leadFlow.innerHTML=`<div class="eyebrow">MONDAY GAME PLAN • BUILD FLOW + CLOSE THE WARM MONEY</div><div class="leadFlowTitle">Two positive responses are now on today’s board</div><div class="leadFlowCopy">Germain Kennard and Larry Marion are both live warm conversations today. Work those two while they are engaged, then keep moving through the strongest due follow-ups and protect the scheduled close windows.</div><div class="leadFlowMix"><div><b>35%</b><span>Fresh Lead Flow</span></div><div><b>40%</b><span>Due Follow-Ups</span></div><div><b>25%</b><span>Appointments + Close</span></div></div>`;
    ...
    const pipelineStats=document.querySelectorAll('#pipelineView .statNum'); const pipelineCounts=[41,22,6,10,9,5,24];
